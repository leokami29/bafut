  ...
  return (
    ...
    >
      ...
      <p>
        ...
        pendiente; cancelación según el estado y la anticipación al inicio.
      </p>
      <ul>
        <li>
          BaFut aloja el pedido y el archivo del comprobante para que el dueño lo revise;
          <strong>no</strong> recibe ni retiene el pago del alquiler.
        </li>
        <li>
        ...
        <li>
          ...
          entre el jugador y el dueño.
        </li>
      </ul>

      <h2>5. Directorio y reclamo de canchas (ownership)</h2>
      <p>
